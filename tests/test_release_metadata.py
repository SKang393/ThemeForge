...
class ReleaseMetadataTests(unittest.TestCase):
    def test_version_metadata_is_1_1_0(self):
        ...
        self.assertEqual(init_version, "1.1.0")

    def test_readme_and_build_defaults_reference_1_1_0(self):
        readme = (ROOT / "README.md").read_text(encoding="utf-8")
        build_script = (ROOT / "scripts" / "build_windows_portable.ps1").read_text(encoding="utf-8")

        self.assertIn("v1.1.0", readme)
        self.assertRegex(build_script, re.compile(r'\[string\]\$Version = "1\.1\.0"'))
